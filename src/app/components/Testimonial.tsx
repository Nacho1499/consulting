...
const Testimonia = () => {
  return (
    <motion.section
      className="py-20  text-[#2C1F02] font-sans"
        ...
        >
          {testimonials.map((t, index) => (
            <SwiperSlide key={index} className="flex">
              ...
              >
                <FaQuoteLeft className="text-green-800 text-2xl mb-4" />
                <p className="text-gray-800 italic text-base mb-6 leading-relaxed">
                  “{t.text}”
                </p>
