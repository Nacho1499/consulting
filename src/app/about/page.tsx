    ...
    <>
      <div className="bg-[#F5F5F5] text-[#2C1F02] font-sans">
        ...
        >
          ...
          <div className="relative border-l-4 border-green-800 pl-8 space-y-10">
            {[
              {
                year: '2020',
                title: 'The Beginning',
              ...
              <motion.div key={idx} className="relative" variants={fadeInUp}>
                <div className="absolute -left-[1.2rem] top-1.5 text-green-800">
                  <FaDotCircle size={20} />
                </div>
                <div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              >
                <div className="text-3xl font-bold text-green-800 mb-2">{index + 1}</div>
